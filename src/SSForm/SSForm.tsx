...
export const SSForm = (props: FormProps) => (
  <SSFContainer>
    <GlobalStyles />
    <Title>GET BOOT CAMP INFO</Title>
    <Form>
      {props.count === 0 ? (
        <>
      ...
      {props.count === 4 ? <h3>Success</h3> : null}
      ...
      {props.count !== 4 ? (
        <ButtonContainer count={props.count}>
          ...
          <Button background="#76acdc" bold type="submit" onClick={props.next}>
            NEXT
          </Button>
        </ButtonContainer>
      ) : null}
